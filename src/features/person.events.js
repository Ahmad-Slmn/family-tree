...
const helper = textEl(
  'p',
  'يوفّر هذا القسم سجلًا زمنيًا موحّدًا لأهم أحداث السيرة لتوثيقها بدقة وسهولة الرجوع إليها.\n' +
  'أضف الأحداث (مع التاريخ/السنة والمكان) وحدّد نوعها ودرجة اليقين والوسوم والمصادر وأرفق الصور عند الحاجة.\n' +
  'يمكنك عرضها كقائمة أو كخط زمني، مع البحث والتصفية وتمييز الأحداث المهمة لإبراز محطات حياتك.',
...
titleInput.className = 'biosec-input event-title-input timeline-title-input';
...
function renderLinkedSources() {
  ...
  if (!sources.length) {
    linkedSourcesField.style.display = 'none';
  ...
  linkedSourcesField.style.display = '';
