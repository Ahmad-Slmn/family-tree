...
{ title:"لوحة الإحصاءات", keywords:"احصاءات تحليلات مخططات CSV عشائر نطاق بحث ترتيب اعمدة تكرار مراجعة", items:[
  ...
  "بطاقات الملخص: عدد العائلات المرئية، جميع الأشخاص، الزوجات، أبناء/بنات (صاحب الشجرة فقط)، غير محدد، متوسطات الأبناء، ونِسَب توفر (الميلاد/العشيرة/الصورة) + نسبة الأشخاص بلا معرّف.",
  ...
  "تصدير CSV يصدّر النطاق الحالي فقط: العائلة، الأشخاص، أبناء/بنات (صاحب الشجرة)، الزوجات، غير محدد.",
...
{ title:"الحذف النهائي والنسخ الاحتياطي", keywords:"حذف نهائي تفريغ نسخ احتياطي", items:[
  "زر «حذف جميع البيانات وإعادة الضبط» للتفريغ الكامل.",
  "نافذة تأكيد توضّح أن جميع البيانات ستُحذف وستتم إعادة ضبط الإعدادات للوضع الافتراضي.",
