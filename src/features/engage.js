  ...
  
{
  ...
  items: [
    "تصدير: زر «تصدير» ينزّل ملف JSON للعائلة الحالية مع بياناتها (أو لجميع العائلات إذا لم تكن هناك عائلة محددة).",
    "استيراد: زر «استيراد» لاختيار ملف JSON صادر من التطبيق (حتى 64MB كحد أقصى).",
